/*****************************************************************************
 *
 * $Id: ColorSpace.java,v 1.1.1.1 2002/08/02 09:48:16 grosbois Exp $
 *
...
public class ColorSpace {
    ...
    final protected void getBoxes() throws ColorSpaceException, IOException {
        ...
        while (true) {
            ...
            if(i==0 && type!=FileFormatBoxes.JP2_SIGNATURE_BOX) {
                ...
                throw new ColorSpaceException ("header box not found in "+
					       "image");
            } else if(type==FileFormatBoxes.JP2_HEADER_BOX) break;
    ...
    public String toString () {
        StringBuffer rep = new StringBuffer ("[ColorSpace is ")
            ...
            .append(getMethod() == ENUMERATED? csbox.
		    getColorSpaceString(): "");
