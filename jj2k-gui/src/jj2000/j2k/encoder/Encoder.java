 ...
 * CVS identifier:
 *
 * $Id: Encoder.java,v 1.1.1.1 2002/07/22 09:26:48 grosbois Exp $
 *
 * Class:                   Encoder
 *
...
public class Encoder implements Runnable {
	...
	Scrambling.OPT_PREFIX // Wavelet coefficient scrambling
    };
	...
	ImgDataConverter converter;
	    ...
	    // **** Scrambling ****
	    Scrambling scrambler = new Scrambling(rois,pl);

            // **** EntropyCoder ****
            try {
                ecoder = EntropyCoder.createInstance(scrambler,pl,
						     encSpec.cblks,
	...
	str = Scrambling.getParameterInfo();
        if(str!=null) for(i=str.length-1; i>=0; i--) vec.addElement(str[i]);
