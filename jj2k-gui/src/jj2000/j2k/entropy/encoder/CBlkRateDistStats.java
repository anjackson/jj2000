 ...
 * CVS identifier:
 *
 * $Id: CBlkRateDistStats.java,v 1.1.1.1 2002/07/22 09:26:49 grosbois Exp $
 *
...
public class CBlkRateDistStats extends CodedCBlk { 
    ...
    /** Reference to the last contributed coding pass (-1 means no
     * contribution yet). This field is updated during the
     * rate-allocation procedure when simulating the layer progressive
     * codestream. */
    public int lastContribIdx = -1;

    /** Offset of the first scrambled codeword */
    public int scrambOff = 0;
