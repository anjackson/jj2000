 ...
 * CVS identifier:
 * 
 * $Id: StdEntropyDecoder.java,v 1.1.1.1 2002/07/22 09:26:48 grosbois Exp $
 * 
...
public class StdEntropyDecoder extends EntropyDecoder 
   ...
   /** The flag bit for the horizontal-left sign in the state array, for row
    ...
    private static final int RLC_MASK_R1R2 =
        STATE_SIG_R1|STATE_SIG_R2 | STATE_VISITED_R1|STATE_VISITED_R2|
    ...
    public DataBlk getCodeBlock(int c,int m,int n,SubbandSyn sb,DataBlk cblk) {
        ...
        cblk.offset = 0;
        cblk.scanw = cblk.w;
	cblk.seed = srcblk.seed;
	cblk.scrambled = srcblk.scrambled;
	cblk.scramblingType = srcblk.scramblingType;
	cblk.scrambOff = cblk.scrambOff;
