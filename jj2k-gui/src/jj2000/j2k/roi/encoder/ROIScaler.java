 ...
 * CVS identifier:
 *
 * $Id: ROIScaler.java,v 1.1.1.1 2002/07/22 09:26:53 grosbois Exp $
 *
 * Class:                   ROIScaler
 *
...
public class ROIScaler extends ImgDataAdapter implements CBlkQuantDataSrcEnc {
     ...
     * */
    public ROIScaler(Quantizer src,ROIMaskGenerator mg,boolean roi,
                     int sLev,boolean uba,EncoderSpecs encSpec) {
        super(src);
        this.src = src;
        this.roi = roi;
     ...
     * the options in 'pl'
     * */
    public static ROIScaler createInstance(Quantizer src,ParameterList pl,
